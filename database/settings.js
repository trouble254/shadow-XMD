...
const SettingsDB = database.define('settings', {
    ...
    gurl: {
        type: DataTypes.STRING,
        defaultValue: https://github.com/trouble254/shadow-XMD
        allowNull: false
    },
    timezone: {
        type: DataTypes.STRING,
...
async function getSettings() {
    try {
        ...
        return {
            prefix: ".",
            author: "ShadowTrouble",
            url: "https://files.catbox.moe/07dmp1.jpg",
            gurl: https://github.com/trouble254/shadow-XMD
            timezone: "Africa/Nairobi",
            botname: "Shadow-XMD☘️",
            packname: "Shadow-XMD☘️",
            mode: "public",
           
            sessionName: "Shadow-XMD☘️"
        };
    }
}
